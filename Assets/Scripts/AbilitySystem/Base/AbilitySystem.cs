...
namespace GameAbilitySystem
{
    public class AbilitySystem : BaseDomain<ASCState> // : MonoBehaviour
    {
        ...
        public Dictionary<string, Attribute> Attributes => Attribute.Attributes;
        ...
        {
            foreach (var att in so.AddAttributeSO) Attribute.CreateAttribute(att);

            foreach (var ability in so.AbilitySO) _abilities.TryAdd(ability.skillName, ability);
