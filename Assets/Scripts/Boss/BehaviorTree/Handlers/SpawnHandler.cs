...
namespace BehaviorTree
{
    public class SpawnHandler : ActionHandler
    {
        ...
        public void SetPosition(Vector2 inputPos, Vector2 desiredPos, EPositionType xtype, EPositionType ytype, float delay, GameObject spawnObject)
        {
        ...
        {
            var spawned = ResourcesManager.Instance.Instantiate(_spawnObject);
