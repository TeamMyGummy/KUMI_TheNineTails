...
//todo: 애니메이션을 외부에서 받도록 수정하기
public class Dok : FunctionHandler
{
    ...
    private void PipeAttack()
    {
        ...
        visual.SetActive(true);
        TrackEntry trackEntry = skeletonAnimation.SetAnimation("Pipe attack", false);
    ...
    private void HammerAttack()
    {
        ...
        visual.SetActive(true);
        TrackEntry trackEntry = skeletonAnimation.SetAnimation("Hammer attack", false);
        trackEntry.Complete += CompleteBehavior;
        skeletonAnimation.AddAnimation("Start_idle", true, 0f);
    }
